...
class CitaControllerTest < ActionController::TestCase
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post :create, citum: { fecha: @citum.fecha, nombre: @citum.nombre, status: @citum.status, tema: @citum.tema }
    end
  ...
  test "should update citum" do
    patch :update, id: @citum, citum: { fecha: @citum.fecha, nombre: @citum.nombre, status: @citum.status, tema: @citum.tema }
    assert_redirected_to citum_path(assigns(:citum))
  end
