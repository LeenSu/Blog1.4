...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { contenido: @articulo.contenido, status: @articulo.status, titulo: @articulo.titulo, url: @articulo.url }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { contenido: @articulo.contenido, status: @articulo.status, titulo: @articulo.titulo, url: @articulo.url }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
